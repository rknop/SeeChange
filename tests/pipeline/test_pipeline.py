...
def test_full_run_zogy( decam_exposure, decam_reference, decam_default_calibrators, user ):
    ...
    expected = {
        'x':       np.array( [ 1409.06, 1452.04, 1438.07, 1451.27, 1619.23,
                                167.18, 1358.37,  458.33, 1518.22 ] ),
        'y':       np.array( [  757.31,  806.70, 1462.79, 1627.02, 1881.41,
                               3330.94, 3491.82, 4008.34, 4043.82 ] ),
        'gfit_x':            [ 1408.58, 1451.15, 1437.62, 1450.55, 1619.23,
                                167.09, 1358.17,  458.13, 1516.67 ],
        'gfit_y':            [  757.35,  809.30, 1464.73, 1627.86, 1881.28,
                               3331.05, 3492.08, 4008.55, 4041.57 ],
        'major_width': [ 6.99, 9.00, 8.52, 6.82, 4.00, 3.87, 9.73, 4.70, 8.05 ],
        'minor_width': [ 4.25, 7.14, 7.64, 6.67, 3.09, 2.08, 4.25, 2.32, 7.77 ],
        'neg_frac':      [ 0.29, 0.11, 0.13, 0.13, 0.13, 0.27, 0.06, 0.15, 0.03 ],
        'neg_flux_frac': [ 0.13, 0.15, 0.12, 0.16, 0.07, 0.29, 0.06, 0.18, 0.08 ],
        'psf_flux':      [ 81141., 9051., 2841., 9660., 2231., 544.,  824., 2948., 18165. ],
        'psf_flux_err':  [   451.,  171.,  127.,  170.,   97.,  90.,   87.,  120.,   207. ],
        'aper_flux':     [ 59725., 9655., 3258., 8515., 1817., 363., 1054., 2178., 24985. ],
        'aper_flux_err': [   564.,  208.,  147.,  190.,  106., 102.,  101.,  150.,   267. ],
        'rb':            [ 0.404, 0.341, 0.545, 0.456, 0.791, 0.598, 0.485, 0.642, 0.430 ]
    }
...
def test_full_run_hotpants( decam_exposure, decam_reference, decam_default_calibrators, user ):
    ...
    expected = {
        'x': np.array( [  458.33,  593.75, 1358.17, 1265.52,  949.14,  903.47, 1752.72,  998.42, 983.28,
                         1440.14, 1985.43, 1619.21, 1581.49, 1451.49, 1451.77, 1143.21, 1435.50, 1437.99,
                         1185.98,  246.24, 1450.58, 1453.47, 1409.15, 1435.25, 1576.60, 1573.30 ] ),
        'y': np.array( [ 4008.85, 3527.51, 3492.80, 3409.27, 2847.72, 2747.91, 2620.64, 2278.11, 2273.60,
                         2051.30, 2026.20, 1881.42, 1665.81, 1632.41, 1627.52, 1571.47, 1466.62, 1465.37,
                         1085.24,  933.89,  812.25,  807.52,  758.12,  477.55,  181.67,  180.33 ] ),
        'gfit_x':      [  457.97,  593.58, 1358.18, 1265.73,  949.17,  903.51, 1752.83,  998.43,  983.31,
                         1440.46, 1987.52, 1619.22, 1581.51, 1450.75, 1450.75, 1143.42, 1437.98, 1437.98,
                         1186.01,  246.33, 1451.34, 1451.34, 1408.61, 1435.30, 1576.84, 1575.26 ],
        'gfit_y':      [ 4008.80, 3527.33, 3492.07, 3409.50, 2847.63, 2747.88, 2620.62, 2278.16, 2273.17,
                         2051.11, 2026.28, 1881.33, 1665.88, 1628.52, 1628.52, 1571.61, 1465.25, 1465.25,
                         1085.21,  933.92,  809.48,  809.48,  758.13,  477.70,  181.84,  180.84 ],
        'major_width': [ 6.12, 1.49, 9.70, 4.68, 3.70, 2.19, 2.48, 3.53, 2.51, 8.96, 10.76, 3.92, 3.01, 7.74,
                         7.74, 1.84, 8.15, 8.15, 2.34, 2.08, 8.50, 8.50, 7.11, 1.40, 2.74, 6.30 ],
        'minor_width': [ 2.05, 0.57, 4.14, 1.81, 1.41, 1.37, 1.56, 1.21, 1.04, 5.93,  4.04, 3.18, 1.51, 6.69,
                         6.69, 0.68, 7.55, 7.55, 1.67, 1.53, 6.80, 6.80, 5.69, 0.96, 1.74, 2.94 ],
        'neg_frac':      [ 0.24, 0.23, 0.15, 0.23, 0.15, 0.15, 0.13, 0.22, 0.12, 0.27, 0.22, 0.09, 0.11, 0.11,
                           0.12, 0.24, 0.06, 0.08, 0.16, 0.21, 0.14, 0.13, 0.16, 0.23, 0.06, 0.07 ],
        'neg_flux_frac': [ 0.19, 0.02, 0.12, 0.02, 0.02, 0.02, 0.01, 0.03, 0.01, 0.23, 0.25, 0.06, 0.02, 0.05,
                           0.05, 0.02, 0.04, 0.05, 0.02, 0.02, 0.07, 0.07, 0.06, 0.02, 0.00, 0.01 ],

        'psf_flux':      [   2372.,   4044.,    815.,  12917.,   7402.,   8257.,  13011.,   6465.,   5645.,
                             1042.,   1187.,   2334.,   8751.,   4909.,   9208.,   6368.,   2497.,   3722.,
                             8408.,   9599.,   9117.,   8645.,  96342.,   8026.,  16496.,  14253. ],
        'psf_flux_err':  [    108.,     96.,     87.,    113.,    104.,    106.,    116.,    102.,     99.,
                              126.,    107.,     96.,    108.,    128.,    166.,    104.,    119.,    152.,
                              108.,    110.,    161.,    159.,    446.,    109.,    121.,    116. ],
        'aper_flux':     [   2372.,   4693.,   1057.,  13485.,   5638.,   6608.,  11533.,   5389.,   5409.,
                             1042.,   1167.,   1901.,   6789.,   4947.,   9252.,   5909.,   2989.,   3437.,
                             6383.,   7297.,   9124.,   9636.,  82970.,   9118.,  16090.,  14688. ],
        'aper_flux_err': [    133.,    105.,    100.,    115.,    106.,    107.,    113.,    106.,    106.,
                              123.,    119.,    105.,    108.,    151.,    173.,    107.,    131.,    138.,
                              107.,    108.,    169.,    185.,    444.,    110.,    118.,    116. ],
        'rb': [ 0.668, 0.635, 0.404, 0.789, 0.779, 0.889, 0.852, 0.602, 0.614, 0.789, 0.780, 0.779, 0.775, 0.558,
                0.476, 0.837, 0.530, 0.590, 0.840, 0.809, 0.705, 0.478, 0.524, 0.812, 0.815, 0.326 ]
    }
