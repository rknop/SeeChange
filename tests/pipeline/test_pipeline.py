...
def test_full_run_zogy( decam_exposure, decam_reference, decam_default_calibrators, user ):
    ...
    expected = {
        'x':      np.array( [ 1409.16, 1452.96, 1439.44, 1451.52, 1619.22, 1441.19,
                               167.44, 1358.37,  457.97, 1518.32 ] ),
        'y':      np.array( [  757.65,  807.50, 1463.56, 1627.38, 1881.40, 2048.30,
                              3330.83, 3491.89, 4008.27, 4043.53 ] ),
        'gfit_x':           [ 1408.76, 1451.46, 1438.06, 1450.85, 1619.23, 1441.06,
                               167.31, 1358.17,  457.79, 1516.75 ],
        'gfit_y':           [  757.65,  809.30, 1464.76, 1627.97, 1881.28, 2048.15,
                                3330.98, 3492.08, 4006.71, 4041.56 ],
        'major_width': [  6.72,  8.70,  7.99,  6.74,  4.04,  3.88,  3.78,  9.74,  7.85,  7.81 ],
        'minor_width': [  4.39,  7.06,  7.52,  6.09,  3.16,  2.29,  2.10,  4.25,  6.07,  7.57 ],
        'neg_frac':      [ 0.28, 0.10, 0.11, 0.13, 0.12, 0.18, 0.23, 0.06, 0.11, 0.03 ],
        'neg_flux_frac': [ 0.12, 0.12, 0.07, 0.13, 0.06, 0.22, 0.25, 0.06, 0.12, 0.06 ],
        'psf_flux':      [  92295.,  10520.,   3320.,  10899.,   2282.,   1211.,    570.,    821.,   2888.,  19987. ],
        'psf_flux_err':  [    464.,    183.,    132.,    176.,     97.,    110.,     90.,     87.,    122.,    214. ],
        'aper_flux':     [  68137.,  10950.,   3680.,   9532.,   1881.,    648.,    380.,   1050.,   2685.,  27060. ],
        'aper_flux_err': [    556.,    206.,    145.,    188.,    105.,    123.,    101.,    100.,    149.,    266. ],
        'rb': [ 0.433, 0.388, 0.548, 0.447, 0.792, 0.618, 0.593, 0.487, 0.593, 0.449 ]
    }
    try:
...
def test_full_run_hotpants( decam_exposure, decam_reference, decam_default_calibrators, user ):
    ...
    expected = {
        'x':      np.array( [ 1519.28,  458.16,  458.19,  593.75, 1358.17, 1265.52,  949.14,  903.47, 1752.72,
                               998.42,  983.27, 1984.84, 1619.21, 1581.49, 1451.78, 1143.22, 1435.22, 1439.08,
                              1185.98,  246.24, 1450.97, 1453.27, 1409.10, 1435.25, 1984.47, 1576.61, 1573.30 ] ),
        'y':      np.array( [ 4039.76, 4008.86, 4008.74, 3527.51, 3492.81, 3409.28, 2847.72, 2747.91, 2620.64,
                              2278.10, 2273.60, 2026.03, 1881.41, 1665.81, 1627.62, 1571.47, 1467.10, 1464.80,
                              1085.24,  933.89,  812.43,  808.18,  758.22,  477.55,  220.79,  181.67,  180.33 ] ),
        'gfit_x':           [ 1517.14,  457.85,  457.85,  593.58, 1358.18, 1265.73,  949.17,  903.51, 1752.83,
                               998.43,  983.31, 1984.94, 1619.22, 1581.51, 1450.96, 1143.46, 1438.29, 1438.29,
                               1186.01,  246.33, 1451.52, 1451.52, 1408.75, 1435.30, 1984.73, 1576.84, 1575.26 ],
        'gfit_y':           [ 4041.87, 4008.77, 4008.77, 3527.33, 3492.07, 3409.50, 2847.63, 2747.88, 2620.62,
                              2278.16, 2273.17, 2025.95, 1881.32, 1665.88, 1628.44, 1571.65, 1465.15, 1465.15,
                              1085.21,  933.92,  809.42,  809.42,  758.05,  477.70,  220.52,  181.84,  180.84 ],
        'major_width': [  7.97,  5.89,  5.89,  1.49,  9.75,  4.68,  3.70,  2.19,  2.48,  3.53,  2.52,  4.85,
                          3.95,  3.01,  7.47,  1.96,  7.98,  7.98,  2.34,  2.08,  8.43,  8.43,  7.14,  1.40,
                          3.91,  2.74,  6.30 ],
        'minor_width': [  6.69,  2.03,  2.03,  0.57,  4.19,  1.81,  1.41,  1.37,  1.56,  1.21,  1.04,  3.24,
                          3.19,  1.51,  6.40,  0.69,  7.50,  7.50,  1.67,  1.53,  6.89,  6.89,  5.16,  0.96,
                          1.77,  1.74,  2.94 ],
        'neg_frac':      [ 0.03, 0.20, 0.20, 0.23, 0.14, 0.23, 0.12, 0.13, 0.13, 0.22, 0.12, 0.17, 0.09, 0.11,
                           0.14, 0.24, 0.09, 0.11, 0.16, 0.21, 0.16, 0.14, 0.17, 0.23, 0.30, 0.06, 0.07 ],
        'neg_flux_frac': [ 0.01, 0.20, 0.20, 0.02, 0.12, 0.02, 0.02, 0.02, 0.01, 0.03, 0.01, 0.20, 0.06, 0.02,
                           0.07, 0.02, 0.06, 0.06, 0.02, 0.02, 0.08, 0.08, 0.08, 0.02, 0.22, 0.00, 0.01 ],
        'psf_flux':      [  18893.,   2375.,   3051.,   4050.,    820.,  12925.,   7406.,   8262.,  13013.,
                             6466.,   5645.,   1404.,   2347.,   8752.,  10237.,   6364.,   2165.,   3584.,
                             8401.,   9584.,   8570.,  10265., 103509.,   8016.,   1739.,  16486.,  14245. ],
        'psf_flux_err':  [    186.,    109.,    110.,     96.,     87.,    113.,    104.,    106.,    116.,
                              102.,     99.,    107.,     96.,    108.,    168.,    104.,    112.,    143.,
                              108.,    110.,    157.,    178.,    453.,    109.,    106.,    121.,    116. ],
        'aper_flux':     [  17196.,   2375.,   1323.,   4681.,   1057.,  13466.,   5626.,   6590.,  11471.,
                             5366.,   5371.,   1254.,   1909.,   6765.,   9472.,   5908.,   2042.,   3400.,
                             6365.,   7272.,   7820.,   9737.,  84291.,   9071.,   1557.,  15942.,  14467. ],
        'aper_flux_err': [    214.,    133.,    143.,    104.,     99.,    114.,    105.,    106.,    113.,
                              105.,    105.,    119.,    104.,    107.,    171.,    106.,    124.,    137.,
                              107.,    108.,    161.,    185.,    438.,    110.,    123.,    117.,    115. ],
        'rb': [ 0.448, 0.657, 0.422, 0.628, 0.405, 0.788, 0.778, 0.891, 0.852, 0.602, 0.613, 0.818, 0.779, 0.777,
                0.485, 0.838, 0.521, 0.603, 0.840, 0.809, 0.692, 0.484, 0.528, 0.812, 0.541, 0.814, 0.325 ]
    }
