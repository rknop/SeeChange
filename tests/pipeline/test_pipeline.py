...
def check_full_run_results( ds, exposure, sec_id, ref, expected ):
    ...
    for m in meas.measurements:
        ...
        assert len(w) == 1
        dexen.append( w[0] )
    assert set( dexen ) == set( range(len(expected['x'])) )

    for m, d, i in zip( meas.measurements, deep.deepscores, dexen ):
...
def test_full_run_zogy( decam_exposure, decam_reference, decam_default_calibrators, user ):
    ...
    expected = {
        'x':      np.array( [ 1408.99, 1452.32, 1438.26, 1451.27, 1619.22, 1441.03, 1358.35,  458.32, 1517.99 ] ),
        'y':      np.array( [  757.39,  806.89, 1462.93, 1627.13, 1881.40, 2048.07, 3491.80, 4008.22, 4043.82 ] ),
        'gfit_x':           [ 1408.55, 1451.16, 1437.63, 1450.54, 1619.23, 1440.84, 1358.17,  458.79, 1516.66 ],
        'gfit_y':           [  757.46,  809.31, 1464.77, 1628.00, 1881.28, 2047.96, 3492.07, 4007.18, 4041.56 ],
        'major_width': [  6.97,  8.86,  8.31,  6.95,  4.03,  4.51,  9.73,  6.97,  7.96 ],
        'minor_width': [  4.47,  7.00,  7.45,  6.59,  3.13,  2.17,  4.25,  3.59,  7.64 ],
        'neg_frac':      [ 0.27, 0.11, 0.10, 0.10, 0.13, 0.18, 0.07, 0.14, 0.03 ],
        'neg_flux_frac': [ 0.11, 0.12, 0.07, 0.13, 0.07, 0.19, 0.07, 0.15, 0.06 ],
        'psf_flux':      [  85465.,   9527.,   3032.,  10154.,   2259.,   1003.,    825.,   3116.,  19260. ],
        'psf_flux_err':  [    458.,    174.,    130.,    173.,     97.,    109.,     87.,    122.,    211. ],
        'aper_flux':     [  64121.,  10423.,   3521.,   9145.,   1849.,    595.,   1043.,   2529.,  26170. ],
        'aper_flux_err': [    560.,    206.,    146.,    189.,    105.,    122.,    100.,    149.,    266. ],
        'rb': [ 0.421, 0.346, 0.565, 0.468, 0.794, 0.504, 0.468, 0.649, 0.438 ]
    }
    try:
        ...
        # # To produce the "expected" regression results above; will need to fix indentation
        # #   and add newlines
        # import io
        # strio = io.StringIO()
        # strio.write(
...
def test_full_run_hotpants( decam_exposure, decam_reference, decam_default_calibrators, user ):
    ...
    expected = {
        'x':      np.array( [ 1518.84,  458.31,  459.80,  593.75, 1358.17, 1265.51,  949.14,  903.47, 1752.72,
                               998.42,  983.28, 1985.45, 1619.21, 1581.49, 1451.46, 1451.70, 1143.22, 1441.00,
                              1438.21, 1435.50, 1436.76, 1185.98,  246.24, 1450.63, 1450.31, 1409.06, 1435.25,
                              1576.61, 1573.30 ] ),
        'y':      np.array( [ 4039.46, 4008.88, 4003.33, 3527.51, 3492.80, 3409.27, 2847.72, 2747.91, 2620.64,
                              2278.11, 2273.60, 2026.32, 1881.42, 1665.81, 1632.34, 1627.49, 1571.47, 1466.74,
                              1465.21, 1466.91, 1462.32, 1085.24,  933.89,  812.31,  806.08,  758.20,  477.55,
                               181.67,  180.33 ] ),
        'gfit_x':           [ 1517.02,  457.88,  459.76,  593.58, 1358.18, 1265.73,  949.17,  903.51, 1752.83,
                               998.43,  983.31, 1987.21, 1619.22, 1581.51, 1450.75, 1450.75, 1143.46, 1437.98,
                              1437.98, 1437.98, 1437.98, 1186.01,  246.33, 1451.33, 1451.33, 1408.60, 1435.30,
                              1576.84, 1575.26 ],
        'gfit_y':           [ 4041.83, 4008.78, 4003.49, 3527.33, 3492.07, 3409.50, 2847.63, 2747.88, 2620.62,
                              2278.16, 2273.17, 2026.25, 1881.32, 1665.88, 1628.50, 1628.50, 1571.65, 1465.22,
                              1465.22, 1465.22, 1465.22, 1085.21,  933.92,  809.49,  809.49,  758.15,  477.70,
                               181.84,  180.84 ],
        'major_width': [  7.95,  5.93,  5.68,  1.49,  9.75,  4.68,  3.70,  2.19,  2.48,  3.53,  2.51, 10.10,
                          3.93,  3.01,  7.58,  7.58,  1.96,  8.03,  8.03,  8.03,  8.03,  2.34,  2.08,  8.41,
                          8.41,  7.19,  1.40,  2.74,  6.30 ],
        'minor_width': [  6.82,  2.02,  2.91,  0.57,  4.19,  1.81,  1.41,  1.37,  1.56,  1.21,  1.04,  3.85,
                          3.18,  1.51,  6.56,  6.56,  0.69,  7.48,  7.49,  7.48,  7.48,  1.67,  1.53,  6.84,
                          6.84,  5.56,  0.96,  1.74,  2.94 ],
        'neg_frac':      [ 0.03, 0.23, 0.25, 0.18, 0.14, 0.23, 0.15, 0.15, 0.13, 0.22, 0.12, 0.24, 0.09, 0.11, 0.14,
                           0.12, 0.24, 0.15, 0.12, 0.10, 0.08, 0.16, 0.21, 0.13, 0.09, 0.18, 0.23, 0.06, 0.07 ],
        'neg_flux_frac': [ 0.01, 0.18, 0.20, 0.02, 0.11, 0.02, 0.02, 0.02, 0.01, 0.03, 0.01, 0.25, 0.06, 0.02, 0.06,
                           0.06, 0.02, 0.08, 0.06, 0.06, 0.05, 0.02, 0.02, 0.07, 0.06, 0.06, 0.02, 0.00, 0.01 ],
        'psf_flux':      [  18568.,   2297.,   1952.,   4050.,    822.,  12928.,   7407.,   8262.,  13014.,
                             6467.,   5645.,   1206.,   2339.,   8751.,   5063.,   9642.,   6364.,   2060.,
                             3703.,   2470.,   2256.,   8400.,   9583.,   8982.,   7715.,  98444.,   8017.,
                             16486.,  14245. ],
        'psf_flux_err':  [    194.,    108.,    123.,     96.,     87.,    113.,    104.,    106.,    116.,
                              102.,     99.,    107.,     96.,    108.,    129.,    166.,    104.,    106.,
                              152.,    117.,    110.,    108.,    110.,    159.,    134.,    456.,    109.,
                              121.,    116. ],
        'aper_flux':     [  16481.,   2297.,   1538.,   4678.,   1058.,  13464.,   5627.,   6590.,  11472.,
                             5366.,   5382.,   1155.,   1900.,   6764.,   4851.,   9269.,   5908.,   2282.,
                             3765.,   2591.,   2438.,   6365.,   7270.,   9108.,   6315.,  82111.,   9069.,
                            15930.,  14458. ],
        'aper_flux_err': [    213.,    132.,    140.,    104.,     99.,    114.,    105.,    106.,    113.,
                              105.,    105.,    118.,    104.,    107.,    151.,    172.,    106.,    123.,
                              139.,    128.,    124.,    107.,    108.,    169.,    154.,    443.,    110.,
                              117.,    115. ],
        'rb': [ 0.454, 0.679, 0.584, 0.635, 0.405, 0.789, 0.779, 0.889, 0.852, 0.602, 0.614, 0.781,
                0.780, 0.775, 0.569, 0.471, 0.837, 0.673, 0.644, 0.541, 0.495, 0.840, 0.809, 0.709,
                0.468, 0.526, 0.812, 0.815, 0.326 ]
    }
