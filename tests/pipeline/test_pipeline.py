...
def test_full_run_zogy( decam_exposure, decam_reference, decam_default_calibrators, user ):
    # The source at 1619.23, 1881.41 is a real SN
    expected = {
        'x':      np.array( [ 1409.04, 1452.23, 1438.26, 1451.29, 1619.23, 1358.36,  458.34, 1518.19 ] ),
        'y':      np.array( [  757.30,  806.75, 1462.78, 1627.03, 1881.41, 3491.80, 4008.33, 4043.84 ] ),
        'gfit_x':           [ 1408.58, 1451.14, 1437.60, 1450.55, 1619.23, 1358.17,  458.13, 1516.66 ],
        'gfit_y':           [  757.34,  809.29, 1464.72, 1627.83, 1881.28, 3492.07, 4008.55, 4041.56 ],
        'major_width': [  6.99,  9.05,  8.55,  6.81,  4.00,  9.73,  4.75,  8.10 ],
        'minor_width': [  4.26,  7.12,  7.62,  6.62,  3.09,  4.25,  2.32,  7.77 ],
        'neg_frac':      [ 0.29, 0.12, 0.13, 0.13, 0.14, 0.07, 0.15, 0.03 ],
        'neg_flux_frac': [ 0.13, 0.16, 0.12, 0.16, 0.07, 0.07, 0.18, 0.08 ],
        'psf_flux':      [  81167.,   9048.,   2825.,   9649.,   2229.,    826.,   2930.,  18086. ],
        'psf_flux_err':  [    451.,    171.,    127.,    170.,     97.,     87.,    120.,    207. ],
        'aper_flux':     [  57968.,   9438.,   3161.,   8363.,   1813.,   1043.,   2138.,  24532. ],
        'aper_flux_err': [    564.,    207.,    146.,    189.,    105.,    100.,    149.,    267. ],
        'rb': [ 0.409, 0.339, 0.554, 0.461, 0.794, 0.467, 0.643, 0.433 ]
    }
    try:
...
def test_full_run_hotpants( decam_exposure, decam_reference, decam_default_calibrators, user ):
    ...
    expected = {
        'x':      np.array( [  458.34,  460.10,  593.75, 1358.17, 1265.52,  949.14,  903.47, 1752.72,
                               998.42,  983.27, 1440.12, 1985.43, 1619.21, 1581.49, 1451.49, 1451.77,
                              1143.22, 1435.49, 1437.99, 1185.98,  246.24, 1450.55, 1453.46, 1409.15,
                              1435.25, 1576.61, 1573.30 ] ),
        'y':      np.array( [ 4008.85, 4003.30, 3527.51, 3492.80, 3409.28, 2847.72, 2747.91, 2620.64,
                              2278.11, 2273.60, 2051.29, 2026.20, 1881.42, 1665.81, 1632.41, 1627.52,
                              1571.47, 1466.62, 1465.37, 1085.24,  933.89,  812.24,  807.52,  758.12,
                               477.55,  181.67,  180.33 ] ),
        'gfit_x':           [  457.97,  458.76,  593.58, 1358.18, 1265.73,  949.17,  903.51, 1752.83,
                               998.43,  983.31, 1440.46, 1987.52, 1619.22, 1581.51, 1450.75, 1450.75,
                              1143.46, 1437.98, 1437.98, 1186.01,  246.33, 1451.34, 1451.34, 1408.61,
                              1435.30, 1576.84, 1575.26 ],
        'gfit_y':           [ 4008.80, 4007.30, 3527.33, 3492.07, 3409.50, 2847.63, 2747.88, 2620.62,
                              2278.16, 2273.17, 2051.10, 2026.28, 1881.33, 1665.88, 1628.52, 1628.52,
                              1571.65, 1465.25, 1465.25, 1085.21,  933.92,  809.48,  809.48,  758.13,
                              477.70,  181.84,  180.84 ],
        'major_width': [  6.06,  7.99,  1.49,  9.71,  4.68,  3.69,  2.19,  2.48,  3.53,  2.51,  8.97, 10.77,
                          3.92,  3.01,  7.74,  7.74,  1.96,  8.15,  8.15,  2.34,  2.08,  8.50,  8.50,  7.11,
                          1.40,  2.74,  6.30 ],
        'minor_width': [  2.04,  5.89,  0.57,  4.14,  1.81,  1.41,  1.37,  1.56,  1.21,  1.04,  5.94,  4.04,
                          3.18,  1.51,  6.69,  6.69,  0.69,  7.55,  7.55,  1.67,  1.53,  6.80,  6.80,  5.69,
                          0.96,  1.74,  2.94 ],
        'neg_frac':      [ 0.24, 0.28, 0.23, 0.15, 0.23, 0.12, 0.15, 0.13, 0.22, 0.12, 0.28, 0.21, 0.09, 0.11,
                           0.11, 0.12, 0.24, 0.06, 0.08, 0.16, 0.21, 0.14, 0.13, 0.16, 0.23, 0.06, 0.07 ],
        'neg_flux_frac': [ 0.19, 0.21, 0.02, 0.12, 0.02, 0.02, 0.02, 0.01, 0.03, 0.01, 0.23, 0.24, 0.06, 0.02,
                           0.05, 0.05, 0.02, 0.05, 0.05, 0.02, 0.02, 0.07, 0.07, 0.06, 0.02, 0.00, 0.01 ],
        'psf_flux':      [   2350.,   1691.,   4047.,    815.,  12917.,   7403.,   8258.,  13003.,   6466.,
                             5644.,   1019.,   1186.,   2334.,   8748.,   4908.,   9208.,   6364.,   2494.,
                             3722.,   8402.,   9596.,   9120.,   8661.,  96347.,   8019.,  16489.,  14248. ],
        'psf_flux_err':  [    109.,    118.,     96.,     87.,    113.,    104.,    106.,    116.,    102.,
                               99.,    126.,    107.,     96.,    108.,    128.,    166.,    104.,    119.,
                              152.,    108.,    110.,    161.,    159.,    445.,    109.,    121.,    116. ],
        'aper_flux':     [   2350.,   1509.,   4681.,   1050.,  13459.,   5624.,   6588.,  11463.,   5366.,
                             5378.,   1019.,   1166.,   1892.,   6761.,   4922.,   9191.,   5908.,   2972.,
                             3379.,   6367.,   7280.,   9031.,   9524.,  82425.,   9072.,  15912.,  14474. ],
        'aper_flux_err': [    132.,    142.,    104.,     99.,    114.,    105.,    106.,    113.,    105.,
                              105.,    122.,    118.,    104.,    107.,    151.,    172.,    106.,    130.,
                              138.,    107.,    108.,    167.,    184.,    442.,    110.,    117.,    115. ],
        'rb': [ 0.669, 0.559, 0.635, 0.404, 0.789, 0.779, 0.889, 0.852, 0.602, 0.614, 0.789, 0.780,
                0.779, 0.775, 0.558, 0.476, 0.837, 0.530, 0.551, 0.840, 0.809, 0.705, 0.478, 0.523,
                0.812, 0.815, 0.326 ]
    }
