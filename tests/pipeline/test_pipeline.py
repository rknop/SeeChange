...
def test_full_run_zogy( decam_exposure, decam_reference, decam_default_calibrators, user ):
    ...
    expected = {
        'x':      np.array( [ 1408.98, 1452.18, 1438.21, 1451.25, 1619.22, 1441.04,  167.18, 1358.37,
                               458.32, 1518.15 ] ),
        'y':      np.array( [  757.42,  806.87, 1462.96, 1627.16, 1881.40, 2048.07, 3330.91, 3491.85,
                              4008.20, 4043.76 ] ),
        'gfit_x':           [ 1408.53, 1451.15, 1437.62, 1450.53, 1619.23, 1440.84,  167.09, 1358.17,
                               458.79, 1516.66 ],
        'gfit_y':           [  757.50,  809.32, 1464.79, 1628.03, 1881.28, 2047.97, 3331.05, 3492.07,
                              4007.14, 4041.57 ],
        'major_width': [  6.98,  8.80,  8.19,  6.94,  4.02,  4.41,  3.84,  9.74,  6.85,  7.90 ],
        'minor_width': [  4.54,  6.96,  7.41,  6.55,  3.13,  2.17,  2.10,  4.25,  3.46,  7.60 ],
        'neg_frac':      [ 0.23, 0.11, 0.09, 0.10, 0.13, 0.16, 0.23, 0.07, 0.12, 0.03 ],
        'neg_flux_frac': [ 0.10, 0.12, 0.07, 0.12, 0.07, 0.18, 0.25, 0.06, 0.12, 0.06 ],
        'psf_flux':      [  85657.,   9452.,   2983.,  10153.,   2263.,   1026.,    562.,    822.,   3125.,  18877. ],
        'psf_flux_err':  [    461.,    175.,    130.,    174.,     97.,    109.,     90.,     87.,    122.,    210. ],
        'aper_flux':     [  65540.,  10591.,   3580.,   9270.,   1853.,    616.,    373.,   1049.,   2615.,  26425. ],
        'aper_flux_err': [    560.,    206.,    146.,    189.,    105.,    123.,    101.,    100.,    149.,    266. ],
        'rb': [ 0.433, 0.349, 0.564, 0.474, 0.789, 0.511, 0.597, 0.493, 0.653, 0.438 ]
    }
...
def test_full_run_hotpants( decam_exposure, decam_reference, decam_default_calibrators, user, test_config ):
    ...
    expected = {
        'x':      np.array( [ 1518.86,  458.41,  593.75, 1265.52,  949.14,  903.47, 1752.72,  998.42,  983.28, 1440.25,
                              1985.43, 1619.21, 1581.49, 1451.52, 1451.71, 1143.22, 1438.18, 1435.53, 1436.60, 1185.98,
                               246.24, 1450.58, 1450.29, 1409.06, 1435.24, 1576.61, 1573.30 ] ),
        'y':      np.array( [ 4039.51, 4008.84, 3527.51, 3409.28, 2847.72, 2747.91, 2620.64, 2278.11, 2273.60, 2051.21,
                              2026.33, 1881.42, 1665.81, 1632.30, 1627.47, 1571.47, 1465.24, 1466.96, 1462.43, 1085.24,
                               933.89,  812.29,  806.09,  758.20,  477.55,  181.67,  180.33 ] ),
        'gfit_x':           [ 1517.03,  457.90,  593.58, 1265.73,  949.17,  903.51, 1752.83,  998.43,  983.31, 1440.52,
                              1987.25, 1619.22, 1581.51, 1450.74, 1450.74, 1143.46, 1437.97, 1437.97, 1437.97, 1186.01,
                               246.33, 1451.33, 1451.33, 1408.61, 1435.30, 1576.84, 1575.26 ],
        'gfit_y':           [ 4041.83, 4008.79, 3527.33, 3409.50, 2847.63, 2747.88, 2620.62, 2278.16, 2273.17, 2050.95,
                              2026.25, 1881.32, 1665.88, 1628.51, 1628.51, 1571.65, 1465.22, 1465.22, 1465.22, 1085.21,
                               933.92,  809.49,  809.49,  758.14,  477.70,  181.84,  180.84 ],
        'major_width': [  7.96,  5.89,  1.49,  4.68,  3.70,  2.19,  2.48,  3.53,  2.51,  8.96, 10.18,  3.93,  3.01,
                          7.59,  7.59,  1.96,  8.04,  8.04,  8.04,  2.34,  2.08,  8.42,  8.42,  7.19,  1.40,  2.74,
                          6.30 ],
        'minor_width': [  6.82,  2.02,  0.57,  1.81,  1.41,  1.37,  1.56,  1.21,  1.04,  5.49,  3.90,  3.18,  1.51,
                          6.57,  6.57,  0.69,  7.48,  7.48,  7.48,  1.67,  1.53,  6.83,  6.83,  5.56,  0.96,  1.74,
                          2.94 ],
        'neg_frac':      [ 0.03, 0.21, 0.18, 0.23, 0.12, 0.15, 0.13, 0.22, 0.12, 0.25, 0.21, 0.09, 0.11, 0.13, 0.11,
                           0.24, 0.12, 0.11, 0.08, 0.16, 0.21, 0.13, 0.09, 0.17, 0.23, 0.06, 0.07 ],
        'neg_flux_frac': [ 0.01, 0.17, 0.02, 0.02, 0.02, 0.02, 0.01, 0.03, 0.01, 0.23, 0.23, 0.06, 0.02, 0.06, 0.05,
                           0.02, 0.06, 0.06, 0.05, 0.02, 0.02, 0.07, 0.06, 0.06, 0.02, 0.00, 0.01 ],
        'psf_flux':      [  18799.,   2903.,   4050.,  12926.,   7406.,   8261.,  13013.,   6467.,   5645.,
                             1098.,   1196.,   2339.,   8751.,   5074.,   9580.,   6364.,   3697.,   2483.,
                             2261.,   8400.,   9583.,   9025.,   7697.,  98167.,   8017.,  16486.,  14245. ],
        'psf_flux_err':  [    195.,    109.,     96.,    113.,    104.,    106.,    116.,    102.,     99.,
                              126.,    107.,     96.,    108.,    129.,    166.,    104.,    152.,    117.,
                              110.,    108.,    110.,    159.,    134.,    456.,    109.,    121.,    116. ],
        'aper_flux':     [  16560.,   2306.,   4690.,  13466.,   5627.,   6590.,  11472.,   5367.,   5374.,
                             1138.,   1152.,   1899.,   6764.,   4854.,   9260.,   5908.,   3245.,   2482.,
                             2420.,   6364.,   7270.,   9251.,   6067.,  82092.,   9069.,  15923.,  14479. ],
        'aper_flux_err': [    214.,    133.,    104.,    114.,    105.,    106.,    113.,    105.,    105.,
                              122.,    118.,    104.,    107.,    151.,    172.,    106.,    137.,    126.,
                              124.,    107.,    108.,    170.,    152.,    444.,    110.,    117.,    115. ],
        'rb': [ 0.446, 0.682, 0.635, 0.789, 0.779, 0.889, 0.853, 0.602, 0.614, 0.770, 0.780, 0.780, 0.774, 0.571,
                0.472, 0.837, 0.582, 0.540, 0.571, 0.840, 0.809, 0.708, 0.467, 0.521, 0.812, 0.815, 0.326 ]
    }
